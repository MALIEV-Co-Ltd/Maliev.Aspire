...
*   **[E2E_USER_JOURNEY_SPECIFICATION.md](./E2E_USER_JOURNEY_SPECIFICATION.md)**
    *   Central overview of executable E2E methods, story ids, what each method verifies, and the latest pass/partial/blocked result rollup for the full story catalog.
    *   Use this for quick review of production-gate coverage. Keep detailed story definitions in the catalog and dated command evidence in the run-results document.
