...
public static class LocalServiceIdentityProfileCatalog
{
    ...
    /// <summary>Gets the CountryService identity.</summary>
    public static LocalServiceIdentityProfile CountryService { get; } = new(
        "country-service",
    ...
    /// <summary>Gets the AccountingService identity.</summary>
    public static LocalServiceIdentityProfile AccountingService { get; } = new(
        "accounting-service",
